//Felolvassa a hoszt.txt file-t és szétbontja majd csinál egy indexet belőle varos-utca-házszám szintjén, hogy később tudja ellenőrizni, hogy az áramszünet listában megtalálható a cím
