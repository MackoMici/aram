...
static-check:
	${GO_EXECUTABLE} install github.com/jgautheron/goconst/cmd/goconst
	${GO_EXECUTABLE} install github.com/alecthomas/gocyclo
	#${GO_EXECUTABLE} install github.com/golangci/interfacer
	${GO_EXECUTABLE} install github.com/walle/lll/cmd/lll
	${GO_EXECUTABLE} install github.com/mdempsky/unconvert
	${GO_EXECUTABLE} install mvdan.cc/unparam
	${GO_EXECUTABLE} install honnef.co/go/tools/cmd/staticcheck
